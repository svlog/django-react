...
Check if the backend admin is accessible
...
├── frontend/           # Frontend source code (React with Vite, JSX, SWC)
├── docker/             # Dockerfile and requeriments.txt
├── devcode.yml          # Docker Compose configuration file
```
